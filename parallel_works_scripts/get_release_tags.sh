...
#
# Runs get_release_tags.py (same flags: --pw, --json FILE, --no-verify) and
# evals its "export VAR=TAG" output here, so the <REPO>_RELEASE_TAG
# environment variables land in the terminal session this file is sourced
# from. Prints what was set so it can be verified.
#
